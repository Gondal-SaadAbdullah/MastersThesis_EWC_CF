...
def initDataSetsPermutation():
    ...
    mnistData = read_data_sets("MNIST_data/", one_hot=True)

    ds1 = [mnistData]
    ds2 = permute(mnistData, 1)

    global dataSetOneTrain
    dataSetOneTrain = ds1[0].train
    global dataSetOneTest
    dataSetOneTest = ds1[0].test
    global dataSetOneValidation
    dataSetOneValidation = ds1[0].validation

    global dataSetTwoTrain
    dataSetTwoTrain = ds2.train
    global dataSetTwoTest
    dataSetTwoTest = ds2.test
    global dataSetTwoValidation
    dataSetTwoValidation = ds2.validation
...
def train():
    ...
    Classifier.train_mod(classifier, sess=sess, model_name='saad', model_init_name="",
                     ...
                     testing_data_set=dataSetOneValidation
                     )
    ...
    Classifier.train_mod(classifier, sess=sess, model_name='saad', model_init_name="saad", dataset=dataSetTwoTrain,
